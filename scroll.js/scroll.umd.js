  ...
  function scroll(action) {
    ...
    try {
      ...
      if (typeof action === "boolean") {
        ...
        shouldEnable =
          action === "unlock" || action === "off" || action === "0";
      } else {
      ...
      console.error("Error in scroll control:", error);
